...
public class QnaInstructorController {
    ...
    public ResponseEntity<UnansweredQuestionsResponse> getUnansweredQuestions(
        ...
        GetUnansweredQuestionsQuery query = new GetUnansweredQuestionsQuery(user, limit);
        return ResponseEntity.ok(questionQueryUseCase.findUnansweredQuestionsForInstructor(query));
    }
